...
IZIN=$( curl https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Users/ipvps | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
# Install SSH/OVPN
wget https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Services/Setup && chmod +x Setup && screen -S Setup ./Setup

# Install Script
# download script
cd
wget https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Menu/install-premiumscript.sh -O - -o /dev/null|sh
...
echo "   - Download OpenVPN Config : http://$MYIP/jokerteam.ovpn" | tee -a log-install.txt
