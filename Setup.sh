...
state=Africa
locality=Durban
organization=JokerteamVPN
organizationalunit=JokerteamVPN
commonname=JokerteamVPN
email=joashsingh14@gmail.com

# Password Setup
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/password"
...
rm .profile
wget "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/.profile"
...
if [ $(cat /etc/debian_version) == '10.9' ]; then
  ...
  wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/nginx.conf"
  wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/vps.conf"
  wget -O /etc/nginx/conf.d/monitoring.conf "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/monitoring.conf"
  mkdir -p /home/vps/public_html
  wget -O /home/vps/public_html/index.php "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Panel/index.php"
...
# Install Badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/badvpn-udpgw64"
...
visible_hostname Jokerteam
END
sed -i $MYIP2 /etc/squid/squid.conf

# Install Webmin
wget "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/webmin_1.801_all.deb"
...
wget -O /etc/openvpn/openvpn.zip "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/openvpn.zip"
cd /etc/openvpn/
unzip openvpn.zip
rm -f openvpn.zip
cd
...
# Openvpn Config
cat > /home/vps/public_html/jokerteam.ovpn <<-END
...
END
echo '<ca>' >> /home/vps/public_html/jokerteam.ovpn
cat /etc/openvpn/keys/ca.crt >> /home/vps/public_html/jokerteam.ovpn
echo '</ca>' >> /home/vps/public_html/jokerteam.ovpn
...
# SSH/Dropbear Banner
wget -O /etc/banner "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/banner"
...
# Update BBR
wget https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Other/bbr.sh && chmod +x bbr.sh && ./bbr.sh

# Install DDOS
cd
apt-get -y install dnsutils dsniff
wget https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/DDOS/ddos-deflate-master.zip
...
wget -O /srv/openvpn-monitor.tar "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Panel/openvpn-monitor.tar"
cd /srv
...
wget -O /etc/uwsgi/apps-available/openvpn-monitor.ini "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Panel/openvpn-monitor.ini"
ln -s /etc/uwsgi/apps-available/openvpn-monitor.ini /etc/uwsgi/apps-enabled/

# GeoIP For OpenVPN Monitor
mkdir -p /var/lib/GeoIP
wget -O /var/lib/GeoIP/GeoLite2-City.mmdb.gz "https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Panel/GeoLite2-City.mmdb.gz"
...
# Install V2ray
wget https://raw.githubusercontent.com/gatotx/AutoScriptDebian10/main/Resources/Services/ins-vt.sh && chmod +x ins-vt.sh && sed -i -e 's/\r$//' ins-vt.sh && screen -S v2ray ./ins-vt.sh